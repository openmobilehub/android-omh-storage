...
dependencies {
    ...
    if (useLocalProjects) {
        ...
        implementation("com.openmobilehub.android.storage:core:2.0.1-alpha")
        implementation("com.openmobilehub.android.storage:plugin-googledrive-gms:2.0.1-alpha")
        implementation("com.openmobilehub.android.storage:plugin-googledrive-non-gms:2.0.1-alpha")
        implementation("com.openmobilehub.android.storage:plugin-onedrive:2.0.1-alpha")
        implementation("com.openmobilehub.android.storage:plugin-dropbox:2.0.1-alpha")
    }
