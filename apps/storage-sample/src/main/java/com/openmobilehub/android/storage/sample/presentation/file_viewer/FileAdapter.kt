...
class FileAdapter(
    ...
    private class DiffCallBack : ItemCallback<OmhStorageEntity>() {
        ...
        override fun areItemsTheSame(oldItem: OmhStorageEntity, newItem: OmhStorageEntity) = oldItem.id == newItem.id

        override fun areContentsTheSame(oldItem: OmhStorageEntity, newItem: OmhStorageEntity) = oldItem == newItem
    }
